...
class CameraGUI(QWidget):
    ...
    def update_ui(self, frame1, frame2, state, alarm):
        ...
        self.state_label.setText(
            f"State: {state} | Alarm: {'ON' if alarm else 'OFF'}"
        )
...
class App:
    ...
    def update(self):
        global state, alarm_active, past_target_area1, past_target_area2, state2start, configs, output_dir, video_writer1, video_writer2, last_save_time

        frame1 = picam2.capture_array()
        frame2 = picam3.capture_array()

        self.latest_frame1 = frame1.copy()
        self.latest_frame2 = frame2.copy()
